...
const Hero = () => {
  ...
  // ✅ WHATSAPP HANDLER (SAME AS HEADER)
  const openWhatsApp = () => {
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Experience <span className="text-gold">Luxury Living</span>
            <br />
            in Pune
          </motion.h1>
